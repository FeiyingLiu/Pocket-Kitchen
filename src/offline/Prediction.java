...
public class Prediction {
	...
	public static void main(String [] args) {
		...
		iterable.forEach(new Block<Document>() {
			// for Each can iterate to read every instance
			@Override
		...
		// calculate the similarity between two people, if B give same rating in same item as USER, B get 1 point
        /**
		var map = function() 
		...
		// Construct mapper function via string
		...
		// MapReduce inout are two strings
		...
		for (User user : similarUsers) {
			...
			// ITEM_COLUMN may be very long, this is why the output are more than 5 results
		}
